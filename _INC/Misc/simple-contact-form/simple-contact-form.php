...
<script src="https://cdn02.jotfor.ms/static/jotform.forms.js?3.3.37132" type="text/javascript"></script>
<script defer src="https://cdnjs.cloudflare.com/ajax/libs/punycode/1.4.1/punycode.js"></script>
<script src="https://cdn03.jotfor.ms/js/vendor/jquery-1.8.0.min.js?v=3.3.37132" type="text/javascript"></script>
<script defer src="https://cdn01.jotfor.ms/js/vendor/maskedinput.min.js?v=3.3.37132" type="text/javascript"></script>
<script defer src="https://cdn02.jotfor.ms/js/vendor/jquery.maskedinput.min.js?v=3.3.37132" type="text/javascript"></script>
...
.form-radio-item .editor-container div:before{display:inline-block;vertical-align:middle;left:0;width:20px;height:20px}.submit-button{font-size:16px;font-weight:normal;font-family:"Inter", sans-serif;border-color:rgba(195, 202, 216, 0.75)}.submit-button{min-width:180px}.form-all .form-pagebreak-back,
...
.form-header-group .form-subHeader{color:#000000}.form-line-error{overflow:hidden;-webkit-transition-property:none;-moz-transition-property:none;-ms-transition-property:none;-o-transition-property:none;transition-property:none;-webkit-transition-duration:0.3s;-moz-transition-duration:0.3s;-ms-transition-duration:0.3s;-o-transition-duration:0.3s;transition-duration:0.3s;-webkit-transition-timing-function:ease;-moz-transition-timing-function:ease;-ms-transition-timing-function:ease;-o-transition-timing-function:ease;transition-timing-function:ease;background-color:#ffd6d6}.form-line-error .form-error-message{background-color:#f23a3c;clear:both;float:none}.form-line-error .form-error-message .form-error-arrow{border-bottom-color:#f23a3c}.form-line-error input:not(#coupon-input),
.form-line-error textarea,
.form-line-error .form-validation-error{border:1px solid #f23a3c;box-shadow:0 0 3px #f23a3c}.supernova{background-color:rgba(255, 255, 255, 0)}.supernova body{background-color:transparent}.supernova .form-all,
.form-all{background-color:rgba(255, 255, 255, 0)}.form-textbox,
.form-textarea,
.form-radio-other-input,
.form-checkbox-other-input,
.form-captcha input,
.form-spinner input{background-color:#ffffff}.form-matrix-table tr{border-color:rgba(230, 230, 230, 0)}.form-matrix-table tr:nth-child(2n){background-color:rgba(242, 242, 242, 0)}.form-all{color:#000000}.form-label-top,
.form-label-left,
.form-label-right,
.form-html{color:#000000}.form-line-error{overflow:hidden;-webkit-transition-property:none;-moz-transition-property:none;-ms-transition-property:none;-o-transition-property:none;transition-property:none;-webkit-transition-duration:0.3s;-moz-transition-duration:0.3s;-ms-transition-duration:0.3s;-o-transition-duration:0.3s;transition-duration:0.3s;-webkit-transition-timing-function:ease;-moz-transition-timing-function:ease;-ms-transition-timing-function:ease;-o-transition-timing-function:ease;transition-timing-function:ease;background-color:#ffd6d6}body{background-color:transparent}
...
<form class="jotform-form" action="https://submit.jotformeu.com/submit/223174525543353/" method="post" name="form_223174525543353" id="223174525543353" accept-charset="utf-8" autocomplete="on">
  <input type="hidden" name="formID" value="223174525543353" />
  ...
  <div role="main" class="form-all">
    ...
    <ul class="form-section page-section">
      <li class="form-line" data-type="control_textbox" id="id_9">
        <label class="form-label form-label-top form-label-auto" id="label_9" for="input_9"> Name </label>
        <div id="cid_9" class="form-input-wide" data-layout="half">
          <input type="text" id="input_9" name="q9_name9" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value="" data-component="textbox" aria-labelledby="label_9" />
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_textarea" id="id_6">
        <label class="form-label form-label-top form-label-auto" id="label_6" for="input_6"> Message </label>
        <div id="cid_6" class="form-input-wide" data-layout="full">
          <textarea id="input_6" class="form-textarea" name="q6_message" style="width:648px;height:163px" data-component="textarea" aria-labelledby="label_6"></textarea>
        </div>
      </li>
        ...
        <div id="cid_12" class="form-input-wide jf-required" data-layout="full">
          <div class="form-single-column" role="group" aria-labelledby="label_12" data-component="checkbox">
            <span class="form-checkbox-item" style="clear:left">
              ...
              <input type="checkbox" aria-describedby="label_12" class="form-checkbox validate[required]" id="input_12_0" name="q12_typeA[]" value="I agree to the terms &amp; conditions" required="" />
              <label id="label_input_12_0" for="input_12_0"> I agree to the terms & conditions </label>
            </span>
          </div>
        </div>
      </li>
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="223174525543353" />
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='223174525543353'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  all_spc[i].value = "223174525543353-223174525543353";
}
  </script>
</form>
<script type="text/javascript">JotForm.forwardToEu=true;</script><script src="https://cdn.jotfor.ms//js/vendor/smoothscroll.min.js?v=3.3.37132"></script>
<script src="https://cdn.jotfor.ms//js/errorNavigation.js?v=3.3.37132"></script>

<!-- ============ End of Jot Form Code ============ -->
